...
🐾 [Animal Chatbot](https://github.com/canischilensis/animal-chatbot)**: Educational AI chatbot teaching Chilean biodiversity. Built with LangChain, FastAPI, React, and local LLMs via Ollama, deployed using Docker microservices.
